      ...
      <div className="md:p-6 p-2 md:px-10 grid md:grid-cols-3 grid-cols-2 items-center border-b-penn-red border-b-2">
        ...
        <div className="justify-self-end">
          <div className="flex items-center md:gap-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger className="hidden rounded-lg shrink-0 md:flex justify-center items-center hover:bg-accent hover:text-accent-foreground h-10 w-10 group">
